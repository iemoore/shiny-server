...
output$map <- renderLeaflet({
  leaflet() %>%
    ...
    addProviderTiles("OpenStreetMap.DE",
                     ...
                     group = "Roads") %>%
    addTiles(urlTemplate = 'http://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}',
    ...
    # addControlGPS() %>% 
    # addSearchMarker(map, position = "topright", propertyName = "label",
    #                 initial = FALSE)
